...
while(1):
    ...
    if ret == True:
        ...
        while not wellfound:
            ...
            most_probable_point = get_argmax(H)
        ...
        if iter > 5:
            ...
            track_window = (int(most_probable_point[1] - track_window[2] / 2), int(most_probable_point[0] - track_window[3] / 2), track_window[2], track_window[3])
